...
if ( ! class_exists( 'Startertheme_Protocol_Relative_Theme_Assets' ) ) :
	class Startertheme_Protocol_Relative_Theme_Assets {
		/**
	...
	$Startertheme_protocol_relative_theme_assets = new Startertheme_Protocol_Relative_Theme_Assets;
endif;
