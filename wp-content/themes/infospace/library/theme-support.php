...
if ( ! function_exists( 'startertheme_theme_support' ) ) :
	function startertheme_theme_support() {

		global $namespace;

		// Add language support
		load_theme_textdomain( $namespace, get_template_directory() . '/languages' );
		...
		// add_editor_style( 'dist/assets/css/' . startertheme_asset_path( 'editor.css' ) );
	}
