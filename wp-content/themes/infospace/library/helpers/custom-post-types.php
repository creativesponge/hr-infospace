...
function post_type_module_page()
{
    $labels = array(
        ...
        'singular_name'         => 'Module Homepage',
        'menu_name'             => 'Module Homepages',
        'name_admin_bar'        => 'Module Homepage',
        'archives'              => 'Module Homepage List',
        'parent_item_colon'     => 'Parent Module  Homepage:',
        'all_items'             => 'All Module Homepages',
        'add_new_item'          => 'Add Module Homepage',
        'add_new'               => 'Add Module Homepage',
        'new_item'              => 'New Module Homepage',
        'edit_item'             => 'Edit Module Homepage',
        'update_item'           => 'Update Module Homepage',
        'view_item'             => 'View Module Homepage',
        'search_items'          => 'Search Module Homepage',
        'not_found'             => 'Not found',
        'not_found_in_trash'    => 'Not found in bin',
        'featured_image'        => 'Listing Image',
        'set_featured_image'    => 'Set listing image',
        'remove_featured_image' => 'Remove Module Homepage image',
        'use_featured_image'    => 'Use as Module Homepage image',
        'insert_into_item'      => 'Insert into Module Homepage',
        'uploaded_to_this_item' => 'Uploaded to this Module Homepage',
        'items_list'            => 'Module Homepage list',
        'items_list_navigation' => 'Module Homepage list navigation',
        'filter_items_list'     => 'Filter Module Homepage',
    );

    $args = array(
        'label'                 => 'Module Homepage',
        'description'           => 'Module Homepage item',
        'labels'                => $labels,
...
function post_type_resource_page()
{
    $labels = array(
        ...
        'name_admin_bar'        => 'Landing page',
        'archives'              => 'Landing page List',
        ...
        'featured_image'        => 'Listing Image',
        'set_featured_image'    => 'Set listing image',
        'remove_featured_image' => 'Remove Landing page image',
        'use_featured_image'    => 'Use as Landing page image',
        'insert_into_item'      => 'Insert into Landing page',
        'uploaded_to_this_item' => 'Uploaded to this Landing page',
        'items_list'            => 'Landing page list',
        'items_list_navigation' => 'Landing page list navigation',
        'filter_items_list'     => 'Filter Landing page',
    );
