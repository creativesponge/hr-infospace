...
<?php if (user_has_module_access(1577) || user_has_module_access(1738) || user_has_module_access(1736)) : ?>
    <h2>Alerts</h2>



    <?php if (user_has_module_access(1577)) : ?>
    ...
    <?php endif; ?>
    <?php if (user_has_module_access(1736)) : ?>
        <label class="checkmark-container">
    ...
    <?php endif; ?>
    <?php if (user_has_module_access(1738)) : ?>
        <label class="checkmark-container">
