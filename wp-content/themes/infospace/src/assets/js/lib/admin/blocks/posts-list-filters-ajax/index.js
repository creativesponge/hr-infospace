var posts_list_filters_ajax = {
  init: function () {
    this.posts_list_filters_ajax_fnc();
  },
  posts_list_filters_ajax_fnc: function () {
    /**
     * BLOCK: Post slist with filters ajax
     *
    ...
    if (document.body.classList.contains("block-editor-page")) {
      ...
      registerBlockType("theme/posts-list-filters-ajax", {
        ...
        edit: function( {attributes, className, setAttributes} ) {
          ...
          let numberPostsClass = "show-" + attributes.numberPosts ;

          return (
            <div className={className + ' ' + numberPostsClass}>
              <div className="description-box">
                  
                  <p>Displays a grid of posts</p>
...
export default posts_list_filters_ajax;
