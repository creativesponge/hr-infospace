    ...
    accordion_block: function() {
      ...
      if ( document.body.classList.contains( 'block-editor-page' )) { // check if is a gutenberg page
        ...
        */
        ...
        const MyIcon = () => (
          <svg id="a0e25ff0-08dc-4c8d-bb19-3a4ec433f28c" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 16"><rect x="1" y="1" width="20" height="1" fill="#fff"/><polygon points="22 0 0 0 0 3 22 3 22 0 22 0" fill="#555d65"/><path d="M21,8V18H3V8H21m2-2H1V20H23V6Z" transform="translate(-1 -4)" fill="#555d65"/></svg>
        );
        /**
         ...
         */
        registerBlockType( 'theme/accordion-blocks-item', {
          ...
          attributes: {
           ...
           edit: function( {attributes, className, setAttributes} ) {
                ...
                <h3 className="accordion-page-banner-heading"><PlainText
                  onChange={ content => setAttributes({ mainHeading: content }) }
                  value={ attributes.mainHeading }
                  placeholder="Enter heading here"
                  className="accordion-page-banner-heading-text"
                /></h3>
                <div className="accordion-blocks-container">
                  <InnerBlocks />
                </div>
