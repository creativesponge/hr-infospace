var all_favourites = {
  init: function () {
    this.all_favourites_fnc();
  },
  all_favourites_fnc: function () {
    /**
     * BLOCK: All favourites
     *
