var welcome_text_after = {
  init: function () {
    this.welcomeTextAfter();
  },
  welcomeTextAfter: function () {
    /**
     * BLOCK: Welcome text after
     *
    ...
    if (document.body.classList.contains("block-editor-page")) {
       ...
       */
      registerBlockType("theme/welcome-text-after", {
        // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
        title: __("Welcome Text After"), // Block title.
        ...
        edit: function ({ attributes, className, setAttributes }) {
          ...
          return (
            <div className={className}>
              <div className="welcome-text-after-container">
                <InnerBlocks
                  template={TEMPLATE}
...
export default welcome_text_after;
