var image_text = {
  ...
  imageText: function () {
    ...
    if (document.body.classList.contains("block-editor-page")) {
      ...
      registerBlockType("theme/image-text", {
        // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
        title: __("Text and image"), // Block title.
        ...
        edit: function ({ attributes, className, setAttributes }) {
          const setalignment = (state) => {
            setAttributes({
              imageAlignment: state,
            });
          };

          let alignmentClass =
            attributes.imageAlignment == true ? "reverse" : "";
          ...
          return (
            <div className={className + " " + alignmentClass}>
                ...
                <PanelBody title={__("Styling", "themename")}>
                  <PanelRow>
                    <ToggleControl
                      ...
                      label={__("Reverse", "themename")}
                      checked={attributes.imageAlignment}
              ...
              <div className="image-text">
                ...
                <div className="image-text-image-container">
                  <div
