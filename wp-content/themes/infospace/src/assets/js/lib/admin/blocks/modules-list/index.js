var modules_list = {
  ...
  modulesList: function () {
    ...
    if (document.body.classList.contains("block-editor-page")) {
       ...
       */
      registerBlockType("theme/modules-list", {
        // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
        title: __("Modules list"), // Block title.
          ...
          return (
            <div className={className}>
              <div className="modules-list-container">
                <h1 className="modules-list-heading">
                  <PlainText
                    onChange={(content) =>
                    ...
                    className="modules-list-heading-text"
                  />
                </h1>
                
                <div className="modules-list-footer">
